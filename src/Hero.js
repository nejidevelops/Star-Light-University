          ...
          <div className='mx-[4%] flex items-center justify-center h-96'>
            <div className='flex flex-col justify-center'>
              ...
              <div className='flex space-x-4'>
                <button className='border-2 border-blue-600 rounded-full hover:text-white hover:bg-blue-600 px-6 py-1.5 transition duration-150' id="enr"><a href=" " id="enrl">Enroll Now</a></button>
